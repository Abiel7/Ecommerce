...
public class CustomerApi {
     ...
     */
    public Address getAddressesByCustomerId(String id) throws ApiException {
        ApiResponse<Address> localVarResp = getAddressesByCustomerIdWithHttpInfo(id);
     ...
     */
    public ApiResponse<Address> getAddressesByCustomerIdWithHttpInfo(String id) throws ApiException {
     ...
     */
    public okhttp3.Call getAddressesByCustomerIdAsync(String id, final ApiCallback<Address> _callback) throws ApiException {
    ...
    /**
     * Build call for getCardsByCustomerId
     * @param id Customer Identifier (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getCardsByCustomerIdCall(String id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCardsByCustomerIdValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getCardsByCustomerId(Async)");
        }
        

        okhttp3.Call localVarCall = getCardsByCustomerIdCall(id, _callback);
        return localVarCall;
     ...
     */
    public Card getCardsByCustomerId(String id) throws ApiException {
        ApiResponse<Card> localVarResp = getCardsByCustomerIdWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Card> getCardsByCustomerIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getCardsByCustomerIdValidateBeforeCall(id, null);
     ...
     */
    public okhttp3.Call getCardsByCustomerIdAsync(String id, final ApiCallback<Card> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCardsByCustomerIdValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<Card>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
