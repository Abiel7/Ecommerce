...
=======
	password varchar(40),
>>>>>>> 3aee703043e95eb314606698a4fd5e7c52256149
...
=======
insert into ecomm.orders(id, customer_id, address_id, card_id, order_date, total, payment_id, shipment_id, status) values ('0a59ba9f-629e-4445-8129-b9bce1985d6a','a1b9b31d-e73c-4112-af7c-b68530f38222', 'a731fda1-aaad-42ea-bdbc-a27eeebe2cc0', '618ffaff-cbcd-48d4-8848-a15601e6725b', current_timestamp, 0, NULL, NULL, 'CREATED');
>>>>>>> 3aee703043e95eb314606698a4fd5e7c52256149
=======
create schema if not exists ecomm;
